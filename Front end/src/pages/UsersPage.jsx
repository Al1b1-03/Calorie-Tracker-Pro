...
export default function UsersPage() {
  ...
  const visibleUsers = users.filter(
    (u) => !isAdmin(u.role) && (currentUserId == null || u.id !== currentUserId)
  );
          ...
          <div key={user.id} className="users-card">
            ...
            <div className="users-card__actions">
              <button
                ...
                disabled={actionLoading === user.id || isAdmin(user.role)}
                title={isAdmin(user.role) ? tr.cantBlockAdmin : ''}
              >
              ...
              <button
                ...
                disabled={actionLoading === user.id || isAdmin(user.role)}
                title={isAdmin(user.role) ? tr.cantDeleteAdmin : ''}
              >
